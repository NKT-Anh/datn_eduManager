  ...
  if (isGVCN) {
    return [
      ...
      },
      {
        label: "Lớp chủ nhiệm",
        items: [
          { id: "my-classes", title: "Lớp của tôi", url: `${prefix}/my-classes`, icon: School },
          { id: "students", title: "Học sinh", url: `${prefix}/students`, icon: Users },
          { id: "schedule", title: "Thời khóa biểu", url: `${prefix}/schedule`, icon: Calendar },
          {
            id: "study",
            ...
            children: [
              { id: "grades", title: "Điểm số", url: `${prefix}/grades`, icon: BarChart3 },
              { id: "conduct", title: "Hạnh kiểm", url: `${prefix}/conduct`, icon: ClipboardList },
              { id: "exams", title: "Kỳ thi", url: `${prefix}/exams`, icon: CalendarCheck2Icon },
            ],
          },
        ],
      },
      {
        label: "Khác",
        items: [{ id: "incidents", title: "Sự cố", url: `${prefix}/incidents`, icon: UserCheck }],
      },
      {
        label: "Cá nhân",
        items: [
  ...
  if (isQLBM) {
    return [
      ...
      },
      {
        label: "Bộ môn",
        items: [
          { id: "teachers", title: "Giáo viên bộ môn", url: `${prefix}/teachers`, icon: UsersRound },
          { id: "subjects", title: "Môn học", url: `${prefix}/subjects`, icon: BookOpen },
          { id: "teaching", title: "Phân công giảng dạy", url: `${prefix}/teaching-assignments`, icon: Presentation },
          { id: "schedule", title: "Thời khóa biểu", url: `${prefix}/schedule`, icon: Calendar },
          {
            id: "study",
            title: "Học tập",
      ...
      {
        label: "Khác",
        items: [{ id: "notifications", title: "Thông báo", url: `${prefix}/notifications`, icon: Bell }],
      },
      {
        label: "Cá nhân",
        items: [
    ...
    case "admin":
      return [
          ...
          items: [
            {
              ...
              children: [
                ...
                { title: "Tổ bộ môn", url: `${prefix}/departments`, icon: Users },
                { title: "Tạo tài khoản", url: `${prefix}/batch`, icon: Users },
                { title: "Phân quyền", url: `${prefix}/permissions`, icon: Shield },
              ],
            },
            {
              title: "Cơ sở",
              icon: School,
              children: [
                { title: "Năm học", url: `${prefix}/school-years`, icon: Calendar },
          ...
          items: [
            {
              ...
              children: [
                ...
                { title: "Phân bổ số tiết theo lớp", url: `${prefix}/class-periods`, icon: BookOpen },
              ],
            },
            {
              title: "Điểm số",
              icon: BarChart3,
              children: [
                { title: "Bảng điểm", url: `${prefix}/grades`, icon: BarChart3 },
                { title: "Khởi tạo bảng điểm", url: `${prefix}/init-grades`, icon: Database },
        ...
        },
        {
          label: "Khác",
          items: [
            { title: "Thông báo", url: `${prefix}/notifications`, icon: Bell },
          ],
        },
      ...
      return [
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Hạnh kiểm", url: `${prefix}/conduct`, icon: ClipboardList },
            { title: "Kỳ thi", url: `${prefix}/exams`, icon: CalendarCheck2Icon },
          ],
        },
        {
          label: "Khác",
          items: [
            { title: "Sự cố", url: `${prefix}/incidents`, icon: UserCheck },
            { title: "Thông báo", url: `${prefix}/notifications`, icon: Bell },
          ],
        },
        {
