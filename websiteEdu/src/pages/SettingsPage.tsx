        ...
        <Card className="shadow-card border-border">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 gap-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                  <Label htmlFor="currentSchoolYear">Năm học hiện tại</Label>
                  <Input id="currentSchoolYear" value={settings.currentSchoolYear} onChange={(e) => handleChange('currentSchoolYear', e.target.value)} placeholder="Ví dụ: 2025-2026" />
                </div>
                <div>
                  <Label htmlFor="termStart">Bắt đầu học kỳ</Label>
                  <Input id="termStart" type="date" value={settings.termStart} onChange={(e) => handleChange('termStart', e.target.value)} />
                </div>
                <div>
                  <Label htmlFor="termEnd">Kết thúc học kỳ</Label>
                  <Input id="termEnd" type="date" value={settings.termEnd} onChange={(e) => handleChange('termEnd', e.target.value)} />
                </div>
              </div>
            </div>
          </CardContent>
