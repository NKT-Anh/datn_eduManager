...
const typeMap: Record<string, { label: string; color: string; desc: string }> = {
  ...
  midterm: { label: "Giữa kỳ", color: "orange", desc: "Kỳ thi giữa kỳ - điểm sẽ đồng bộ vào bảng điểm học sinh (midterm)" },
  final: { label: "Cuối kỳ", color: "red", desc: "Kỳ thi cuối kỳ - điểm sẽ đồng bộ vào bảng điểm học sinh (final)" },
};
